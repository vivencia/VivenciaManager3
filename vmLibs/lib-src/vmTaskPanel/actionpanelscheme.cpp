...
ActionPanelScheme::ActionPanelScheme ( const PanelStyle style )
{
	...
	headerButtonFold = ICON ( "def-Fold" );
	headerButtonFoldOver = ICON ( "def-FoldOver" );
	headerButtonUnfold = ICON ( "def-Unfold" );
	headerButtonUnfoldOver = ICON ( "def-UnfoldOver" );
	headerButtonClose = ICON ( "panelClose" );
	headerButtonCloseOver = ICON ( "panelCloseOver" );
