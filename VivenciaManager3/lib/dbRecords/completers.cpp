...
#include "common/fast_library_functions.h"
#include "common/heapmanager.h"
#include "common/global_enums.h"

#include "lib/vmWidgets/vmwidgets.h"
...
void vmCompleters::setCompleter ( vmComboBox* cbo, const COMPLETER_CATEGORIES type ) const
{
	if ( cbo != nullptr && type > COMPLETER_CATEGORIES::NONE )
	{
		QStringList cboList;
		fillList ( type, cboList );
		cbo->setCompleter ( getCompleter ( type ) );
		cbo->addItems ( cboList );
	}
}
