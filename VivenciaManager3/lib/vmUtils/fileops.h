...
#include "../lib/vmNumbers/vmnumberformats.h"
#include "vmlist.h"
...
public:
	...
	static int sysExec ( const QStringList &command_line, const QString& as_root_message = QString () );
	static int sysExec ( const QString& command_line, const QString& as_root_message = QString () );
	...
	static const QString executeAndCaptureOutput ( const QString& arguments, const QString& program, int* exitCode = nullptr, const QString& as_root_message = QString () );
	static bool executeWithFeedFile ( const QString& arguments, const QString& program, const QString& filename, int* exitCode = nullptr, const QString& as_root_message = QString () );
