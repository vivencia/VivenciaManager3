...
void deleteCalculatorInstance ()
{
	heap_del ( Calculator::calc );
}
...
void Calculator::setExpression ( const QString& expr )
{
...
void Calculator::compile ( const Tokens &tokens ) const
{
...
void Calculator::eval ( QString& result )
{
	if ( stc_private->dirty ) {
		Tokens tokens = scan ( stc_private->expression );
