...
namespace Sys_Init
{
	...
	extern passwordSessionManager* passwd_instance;
...
inline passwordSessionManager* PASSWORD_MANAGER ()
{
	if ( Sys_Init::passwd_instance == nullptr )
		Sys_Init::passwd_instance = new passwordSessionManager;
	return Sys_Init::passwd_instance;
}
