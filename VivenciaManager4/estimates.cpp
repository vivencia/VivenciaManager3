...
{	
	NOTIFY ()->messageBox ( TR_FUNC ( "Choose destination job" ), TR_FUNC ( "Please select the client and the job to which to convert this estimate." ) );
	if ( !m_npdlg )
	...
	NOTIFY ()->messageBox ( TR_FUNC ( "Success!" ), project_name + TR_FUNC ( " was converted!" ) );
